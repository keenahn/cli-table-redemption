...
Table.prototype.render = Table.prototype.toString = function() {
  ...
  function getWidth(obj) {
    return typeof obj === 'object' && obj && obj.width !== undefined
      ? obj.width
      : (typeof obj === 'object' && obj !== null ? utils.strlen(obj.text) : utils.strlen(obj)) +
  ...
  function generateRow(items, style) {
    ...
    lines.forEach(function(line, index) {
      ...
      if (index % 2 === 0) {
        line = line.map(l => applyStyles(options.style.zebra.even, l))
      } else {
        line = line.map(l => applyStyles(options.style.zebra.odd, l))
      }
      ret +=
